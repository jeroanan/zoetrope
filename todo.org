...
* DONE The Message Type column seems to be usesless 					 :Messages:
...
* DONE Get rid of redundant truth comparisons for sort arrows :AllProjectList:
* DONE Swap meanings of tick and star marks 						 :AllProjectList:
* TODO Get rid of  redundant truth comparisons for sort arrows :Messages:
