...
* TODO Get rid of querystrings and convert parameters to routeparams :General: [1/2]
pages:
** DONE Project
** TODO Task
...
* TODO Get rid of redundant truth comparisons for sort arrows :Tasks:
* TODO Make project name link to project page :Task:
