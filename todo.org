...
** DONE Add actions to actions menu [4/4]									 :Projects:
*** DONE No More Work
*** DONE Allow More Work
*** DONE Suspend Project
*** DONE Resume Project
** TODO Make timezone into a string rather than just a number		 :HostInfo:
** DONE It seems we don't need the dependency on jinja2 anymore. Remove it. :General:
** DONE Make sidebar invisible on mobile. Make it another section   :Project:
