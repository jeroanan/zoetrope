...
class HostInfo(object):
    ...
    def __init__(self, host_info):
        ...
        self.memory_size = bc.bytes_to_gigabytes(host_info.m_nbytes)
        self.cache_size = host_info.m_cache
        self.swap_size = bc.bytes_to_gigabytes(host_info.m_swap)
        self.disk_size = bc.bytes_to_gigabytes(host_info.d_total)
        self.disk_free = bc.bytes_to_gigabytes(host_info.d_free)
