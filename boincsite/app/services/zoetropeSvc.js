...
angular.module('zoetropeServices')
  .factory('zoetropeSvc', ZoetropeService);

ZoetropeService.$inject = ['jsonSvc'];

function ZoetropeService(jsonSvc) {
  var svc = {
    getStatus: getStatus
  };

  function getStatus(success, error) {
    return jsonSvc.getJson('/zoetrope_status', false).then(success, error);
  }
